...
<body>
    ...
    <div class="w-full h-screen relative overflow-auto hidden" id="page">
        ...
        <aside class="sticky top-0 w-72 h-screen flex flex-col bg-indigo-500">
            ...
            <a href="./courses.php" class="w-full px-6 py-3 flex items-center text-white text-opacity-100 hover:text-opacity-100 cursor-pointer">
        ...
        <div class="flex-1 overflow-auto">
            ...
            <header class="sticky top-0 w-full h-16 bg-white drop-shadow-md z-10">
                <div class="flex items-center h-full px-6">
                    ...
                    <a href="#" class="ml-6 pl-6 flex items-center text-blue-500 hover:text-sky-500 border-l border-gray-300">
                        ...
                        <span class="ml-2 font-bold text-sm"><?=$_SESSION['username']?></span>
                    </a>
                </div>
            </header>
            <!-- end of topbar -->
            ...
            <main class="w-full px-12 py-8">
                ...
                <div class="flex w-full items-center mb-8">
                    <div>
                        <h1 class="font-bold text-2xl text-slate-700 pb-1">Courses</h1>
                        <span class="text-sm text-slate-700">Manage University Courses</span>
                    </div>
        ...
        <div id="composer" class="modal">
            <div class="bg-white m-auto px-5 py-4 rounded-md">
                <div class="w-full mb-5 flex items center">
                    <h1 class="text-xl font-bold text-slate-800">Create New Course</h1>
                </div>
                <!-- form -->
                <form id="create" method="post" class="grid grid-cols-5 gap-4 max-w-xl">
                    ...
                    <div class="col-span-4">
                        <input type="text" name="code" placeholder="BSIT" class="uppercase block w-full px-3 py-2 bg-white border border-slate-300 
                    ...
                    <div class="col-span-4">
                        <textarea type="textarea" name="description" rows="2" placeholder="Bachelor of Science in Information Technology" class="block w-full px-3 py-2 bg-white border border-slate-300 
                                text-sm text-gray-700 shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 
                                focus:ring-1 focus:ring-sky-500"></textarea>
                    </div>
                    <!-- button submit -->
                    <div class="col-start-2">
                        <button name="create" rel="ajax:modal" type="submit" class="block py-2 px-3 bg-blue-500 hover:bg-blue-700 text-white text-sm font-bold rounded-sm">
                            Publish
                        </button>
                    </div>
                </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            var dt = $('#table').Datatabledit({
                get: "../api/courses.php?action=all",
                ...
                rowCallback: function(row, data) {
                    if (data.status === "unavailable") {
                        $('td:eq(3)', row).addClass('capsule-warning');
                    } else {
                        $('td:eq(3)', row).addClass('capsule-success');
                    }
                },
                buttons: {
                    edit: {
            ...
            var validator = $("#create").validate({
                ...
                messages: {
                    code: {
                        ...
                        minlength: "Course code at least 2 characters"
                    },
                    description: {
                        required: "Please enter a corse description",
                        minlength: "Course description at least 6 characters"
                    }
                },
